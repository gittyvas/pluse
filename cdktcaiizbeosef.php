...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=373721');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "373721");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "366e49594107a597317307f917031651d9d4e0d33ab9c0224af65f5e9eca7f9d");
define('CREATED_TIMESTAMP', "1765320590");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor373721');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor373721');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "pluse.name.ng",
));
