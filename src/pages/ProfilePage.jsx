...
// FooterLink (optional links at bottom)
...
export default function ProfilePage() {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      ...
      setProfile(data.user); // ✅ Fix: assign `user` object
        ...
        <div style={{
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <button onClick={() => setShowDisconnectModal(true)} style={{
              background: "#FF6347", color: "#fff", padding: "10px 20px", border: "none", borderRadius: "6px", cursor: "pointer"
            }}>
              Disconnect Google
            </button>
          </div>
          ...
          <div style={{ marginTop: "20px" }}>
            <h3>Danger Zone</h3>
            <p style={{ color: mutedTextColor }}>This will permanently delete your account and data.</p>
            <button onClick={() => setShowDeleteModal(true)} style={{
              background: "#DC3545", color: "#fff", padding: "10px 20px", border: "none", borderRadius: "6px", cursor: "pointer"
            }}>
              Delete My Account
            </button>
          </div>
